...
export const Game = () => {
  ...
  // Zmień na ruch komputera, sprawdź, czy gra się skończyła i zatrzymaj, jeśli tak; jeśli nie strzelaj do odpowiedniego pola
  ...
  // Sprawdzenie, czy gracz lub komputer zakończył grę
